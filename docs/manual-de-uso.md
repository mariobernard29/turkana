...
![Pantalla de acceso con el número de empleado escrito y el saludo debajo](img/01-login-numero-empleado.jpg)
...
![Pantalla de venta del punto de venta](img/03-pos-venta.jpg)
...
![Menú del punto de venta abierto](img/04-pos-menu.jpg)
...
![Formulario de nueva perforación con el selector de orejas](img/09-perforacion-nueva.jpg)
...
![Panel de administración](img/02-admin-dashboard.jpg)
...
![Tarjeta de tallas del formulario de producto](img/06-producto-tallas.jpg)
...
![Pantalla de productos con los botones de plantilla e importación](img/05-productos-lista.jpg)
...
![Lista de inventario](img/07-inventario.jpg)
...
![Ventana de movimiento de inventario](img/08-inventario-movimiento.jpg)
